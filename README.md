...
<h1 align="center"> React Dynamic JSON tabele</h1>
<h3 align="center"> A css agnostic sematically correct HTML table </h3>  
...
<p align="justify"> 
  This project aims to create a quick start compliant HTML table, composable from JSON. With the feature you might expect from a table, sorting, paging, search, customisable cells (images, html, css ...) and table header.
</p>
